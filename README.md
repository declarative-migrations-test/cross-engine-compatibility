# cross-engine-compatibility
    ...
    **Live infrastructure:** PostgreSQL, CockroachDB
    ...
    1. Verify portable plan equivalence and preflight classification across PostgreSQL and CockroachDB across the supported happy-path states and canonical fixtures.
2. Verify portable plan equivalence and preflight classification across PostgreSQL and CockroachDB under retries, interruption, concurrency, offline operation, or partial failure.
3. Verify portable plan equivalence and preflight classification across PostgreSQL and CockroachDB preserves authorization, idempotency, integrity, observability, and actionable failure classification.
